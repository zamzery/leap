...
?>
<title>Leap Works - Pedidos</title>
<style>
.text-bg-secondary {
					...
					<form name="formulario" id="formulario" method="POST">
						<div class="row">
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-12 mb-3">
								...
								<input type="text" class="form-control" name="pedidoID" id="pedidoID"
									placeholder="Número de Pedido" readonly>
							</div>
							...
							<div class="form-group col-lg-12 col-md-12 col-sm-12 mb-3">
								<button id="btnAgregarArt" type="button" class="btn btn-primary" data-bs-toggle="modal"
									data-bs-target="#modalAgregarProductos"><i class="fa-solid fa-plus espaciado-icn"></i>
			...
			<div class="modal-body">
				<form name="formFactura" id="formFactura" method="POST">
					...
					<div class="form-group col-lg-3 col-md-3 col-sm-12 mb-3">
						...
						<select id="moneda" name="moneda" class="form-control selectpicker" onchange="obtenerTipoCambio(this.value)" required>
				...
				<div class="row form-group mb-3 pb-3" style="background-color:#eeebf5;">
					...
					<div class="form-group col-lg-3 col-md-3 col-sm-12 mb-3">
						...
						<select type="text" class="form-control selectpicker" name="formadePago"
							id="formadePago" title="Forma de Pago" required>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 mb-3">
						<table id="detallesFactura"
							...
							<tfoot>
								...
								<th style="width:180px;text-align:right;">$<strong id="grantotal_factura">0.00</strong></th>
							</tfoot>
						</table>
					</div>
				</form>
