...
?>
<title>Leap Works - Unidad Medida</title>
<!--Contenido-->
			...
			<div class="row align-items-center justify-content-between">
				<div class="col-auto mt-4 listadoregistros">
					<h1 class="page-header-title">
						<div class="page-header-icon"><i class="fa-solid fa-ruler"></i></div>
						Unidades de Medida
					</h1>
					<div class="page-header-subtitle text-light">Administración y creación de unidades de medida para
						facturación.</div>
				</div>
			</div>
		</div>
...
<div class="container-xl px-4 mt-n10" id="container-body">
	<div class="row">
		<div class="col-sm-12 col-lg-12">
			<!-- Comienza Contenedor de Unidad de Medida -->
			...
			<div class="card">
				...
				<!-- Comienza div de Unidad de Medida -->
					...
					<form name="formulario" id="formulario" method="POST">
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 mb-3">
								<h1 class="box-title" style="font-size: 24px;">UNIDAD DE MEDIDA</h1>
							</div>
							<div class="form-group col-lg-8 col-md-8 col-sm-12 mb-3">
								<label><span style="color:red;">*</span>Nombre de la Unidad de Medida:</label>
								<input type="hidden" name="unidadmedidaID" id="unidadmedidaID">
								<input type="text" class="form-control" name="nombre" id="nombre"
									placeholder="Nombre de Unidad de Medida" required>
							</div>
							<div class="form-group col-lg-4 col-md-4 col-sm-12 mb-3">
								<label><span style="color:red;">*</span>Clave Unidad:</label>
								<input type="text" class="form-control" name="unidad" id="unidad"
									placeholder="Unidad de Medida" required>
							</div>
							<div class="form-group col-lg-4 col-md-4 col-sm-12 mb-3" style="display:none;">
								<label>Abreviatura:</label>
								<input type="text" class="form-control" name="abreviatura" id="abreviatura"
									placeholder="Abreviatura de Unidad de Medida">
							</div>
		...
		</div><!-- /.termina Contenedor de Unidad de Medida -->
	</div><!-- /.row -->
</div><!-- /.container-fluid -->
<!--Fin-Contenido-->
<?php
...
?>
<script type="text/javascript" src="../services/unidadmedida.js"></script>
<?php 
}
ob_end_flush();
?>