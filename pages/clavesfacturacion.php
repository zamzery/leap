...
if ($_SESSION['clavefacturacionver']==1){
?>
<title>Leap Works - Claves Facturas</title>
<!--Contenido-->
		...
		<div class="page-header-content pt-4">
			<div class="row align-items-center justify-content-between">
				<div class="col-auto mt-4 listadoregistros">
					...
					<div class="page-header-subtitle text-light">Administración y creación de las claves de facturación.
					</div>
				</div>
			</div>
		</div>
					...
					<form name="formulario" id="formulario" method="POST">
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 mb-3">
								<h1 class="box-title" style="font-size: 24px;">CLAVE DE FACTURACIÓN</h1>
							</div>
							<div class="form-group col-lg-8 col-md-8 col-sm-12 mb-3">
								<label><span style="color:red;">*</span>Nombre de la Clave de Facturación:</label>
								<input type="hidden" name="claveID" id="claveID">
								<input type="text" class="form-control" name="nombre" id="nombre"
									placeholder="Nombre de la Clave de Facturación" required>
							</div>
...
?>
<script type="text/javascript" src="../services/clavefacturacion.js"></script>
<?php 
}
ob_end_flush();
?>