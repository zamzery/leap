...
<body class="permission_denied">
	...
	<div class="denied__wrapper">
		<h1>404</h1>
		<h3>¿TE HAZ PEDIDO EN ESTE <span>ESPACIO</span>? <br>parece que la página que buscas no existe.</h3>
		<img id="astronaut" src="../public/images/astronaut.svg" />
		<img id="planet" src="../public/images/planet.svg" />
		<a href="https://a/"><button class="denied__link">Ir a casa</button></a>
	</div>
