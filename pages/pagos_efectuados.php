...
?>
<title>Leap Works - Pagos Efectuados</title>
<style>
		...
		<div class="page-header-content pt-4">
			<div class="row align-items-center justify-content-between">
				<div class="col-auto mt-4 listadoregistros">
					...
					<div class="page-header-subtitle text-light">Administración y creación de pagos efectuados.</div>
				</div>
			</div>
		</div>
	</div>
...
?>
<script type="text/javascript" src="../services/pago_efectuado.js"></script>
<?php 
}
ob_end_flush();
?>